...
$sql="SELECT * FROM `agent_technicien` where MATRICULE='".$matricule_saved."'";
...
<aside class="profile-card">
    ...
    <header>
        ...
        <!-- the username -->
        <h1>MATRICULE : <?php echo "$r[0]"?></h1>
        
        <!-- and role or location -->
        <h2>NOM : <?php echo "$r[1]"?></h2>
		<h2>PRENOM :<?php echo "$r[2]"?></h2>
    ...
    <div class="profile-bio">
        ...
        <p>POST :<?php echo "$r[3]"?> </p>
		<p>SERVICE  :<?php echo "$r[4]"?> </p>
